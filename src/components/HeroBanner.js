...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '197px', xs: '70px' }, ml: { sm: '50px' }}} position="relative" p="20px">
    ...
    <Typography color="#FF2625" fontWeight="bolder" fontSize="35px" className='explore-exercises-button'> Active Fitness</Typography>
  ...
  Check out the most effective exercises personalized to you
    ...
    <Typography className="exercise-heading" fontWeight="bold" color="rgb(250,0,25)" 
  sx={{ opacity: '0.3', 
